...
const NewCommand = () => {
  ...
  useEffect(() => {
    for(let productInArray = 0; productInArray < listOfProducts.length; productInArray++){
      setTotalPrice(totalPrice + products.filter(ele => ele.id === listOfProducts[productInArray])[0].price)
    }
  }, [listOfProducts])
      ...
      <div className={styles.container}>
                ...
                <div key={index}>
                  ...
                  <div className={styles.right}>
                      ...
                      >
                        ...
                        >
                          {listOfProducts.filter((i) => i === item).length === 1 ?  <DeleteIcon/> : <RemoveIcon />}
                        ...
                        <Button
                          onClick={() => addNewProductToList(item)}
                        >
        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.complete_command}>
            <Box>
              <Button variant="contained" color="success" size="large" sx={{width: "100%", marginTop: "2vh"}}>
